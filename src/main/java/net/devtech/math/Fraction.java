...
public interface Fraction extends Comparable<Fraction> {
	...
	static LongFraction of(long numerator, long denominator) {
		...
		if(numerator == denominator) return Fraction.ONE;

		if(numerator < 16 && denominator < 16) {
			return LongFraction.CACHE[(int) (numerator * 16 + (denominator - 1))];
		}
	...
	/**
	 * @return the <b>unsimplified</b> numerator of the fraction
	 */
	BigInteger getNumerator();

	/**
	 * @return the <b>unsimplified</b> denominator of the fraction
	 */
